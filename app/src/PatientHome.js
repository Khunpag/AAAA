                    ...
                    <Row>
                      ...
                      <Col md={5}>
                        <div className="">
                          ...
                          <Link
                            to={`/patient/add`}
                            className="bg-green re-bor button-add-p rounded-3 button1 d-inline-block "
                          >
                          ...
                          <Link
                            to={`/report/all`}
                            className="re-bor rounded-3 d-inline-block button1 button-add-p chart-btn"
                          >
                            <i className="fa-solid fa-chart-line fa-lg m-right-add-pa"></i>
                            กิจกรรมบำบัด
                          </Link>
                          {/* </span> */}
                        </div>
